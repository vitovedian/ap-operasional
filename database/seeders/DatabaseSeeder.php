    ...
    public function run(): void
    {
        ...
        $suratTugasSeeds = [
            [
                ...
                'tanggal_kegiatan_berakhir' => now()->addDays(4)->toDateString(),
            ...
            [
                ...
                'tanggal_kegiatan_berakhir' => now()->addDays(8)->toDateString(),
            ...
            [
                ...
                'tanggal_kegiatan_berakhir' => now()->addDays(7)->toDateString(),
                'jenis_kegiatan' => 'offline',
            ...
            [
                ...
                'tanggal_kegiatan_berakhir' => now()->addDays(9)->toDateString(),
                'jenis_kegiatan' => 'online',
        ...
        foreach ($suratTugasSeeds as $seed) {
            ...
            $payload = [
                ...
                'tanggal_kegiatan_berakhir' => $seed['tanggal_kegiatan_berakhir'] ?? $seed['tanggal_kegiatan'],
                'pic_id' => $pic->id,
                'jenis_kegiatan' => $seed['jenis_kegiatan'] ?? 'offline',
